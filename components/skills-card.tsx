  ...
  return (
    <div className="group relative h-full overflow-hidden rounded-2xl border border-border bg-card p-8 transition-all duration-300 hover:border-primary/50">
      ...
      <div className="relative z-10">
        <h2 className="mb-6 text-2xl font-bold tracking-tight text-foreground">Core Skills</h2>
              ...
              <div className="flex flex-wrap gap-2">
                {cat.skills.map((skill) => (
                  <motion.span
                    ...
                    className="text-xs bg-secondary border border-border/50 text-foreground px-3 py-1.5 rounded-full hover:border-primary/50 transition-all duration-200"
                  >
                    {skill}
                  </motion.span>
                ))}
