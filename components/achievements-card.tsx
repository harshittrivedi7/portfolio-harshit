  ...
  return (
    <div className="group relative h-full overflow-hidden rounded-2xl border border-border bg-card p-8 transition-all duration-300 hover:border-primary/50">
      ...
      <div className="relative z-10">
        <h2 className="mb-6 text-2xl font-bold tracking-tight text-foreground">Achievements</h2>
          ...
          {achievements.map((achievement, index) => {
            ...
            return (
              <motion.div
                ...
                className="relative overflow-hidden rounded-lg border border-border/50 bg-secondary p-3 transition-all duration-300 hover:border-primary/50"
              >
